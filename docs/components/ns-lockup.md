...
![Lockup - Lockjaw](https://user-images.githubusercontent.com/45626534/74159521-d7648480-4c13-11ea-808c-a45297540339.png)
...
| F | Illustration | Use this optional illustration to support and highlight the content. The illustration should relate to the product or service you are talking about. Only available on the Lockjaw and Locknut variants. The [specification table](https://docs.britishgas.design/components/ns-lockup#specification) has a list of options. |
| G | Decoration | An optional background decoration added to the surrounding panel. Use for styling and to provide depth to the content. Only available on the Lockjaw variant. |
...
| `decoration` | `string` |  | See [Illustration component in Storybook](https://britishgas.co.uk/nucleus/demo/index.html?path=/story/ns-illustrations--appliance) | Adds illustration between the text and image. |
