...
| `passwordValidation` | `array` | `['hasNumbers', 'hasLetters', 'isBetween(8, 20)']` | |  A way to assist that valid password is added and to show an error message when they're not. See [ns-inputter](components/ns-inputter.md#validation)
