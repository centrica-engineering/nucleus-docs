...
* If you've noticed anything that you'd like to change in this document, feel free to [edit](https://github.com/ConnectedHomes/nucleus-docs/blob/master/docs/how-to/names-of-things.md). [†]
