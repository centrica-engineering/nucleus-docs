...
import ExampleStandard from '../_examples/patterns/messaging/skyline.html';
...
![Validation message on radio buttons](../../../assets/patterns/messaging/error-inline-validation.webp)
...
![Warning message displayed in journey](../../../assets/patterns/messaging/warning-highlighter.webp)
...
![Roadblock message](../../../assets/patterns/messaging/roadblock.webp)
...
![Messaging example for submitting a meter reading](../../../assets/patterns/messaging/success-highlighter.webp)
