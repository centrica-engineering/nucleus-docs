...
import ExampleStandard from '../_examples/components/ns-card/standard.html';
import ExampleSection from '../_examples/components/ns-card/section.html';
import ExampleSupport from '../_examples/components/ns-card/support.html';
import ExampleFlat from '../_examples/components/ns-card/flat.html';
