...
import ExampleStandard from '../_examples/components/card/standard.html';
import ExampleSection from '../_examples/components/card/section.html';
import ExampleSupport from '../_examples/components/card/support.html';
import ExampleFlat from '../_examples/components/card/flat.html';
...
![Card - Section](../../../assets/components/card/content-guidance-section.webp)
...
![Card - Support](../../../assets/components/card/content-guidance-suppport.webp)
...
![Card - Flat](../../../assets/components/card/content-guidance-flat.webp)
