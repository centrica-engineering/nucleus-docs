...
<ExampleViewer src="ns-card/standard.html" />

#### Section

`type="section"`

<ExampleViewer src="ns-card/section.html" />

#### Support

`type="support"`

<ExampleViewer src="ns-card/support.html" />
#### Flat

`type="flat"`

<ExampleViewer src="ns-card/flat.html" />
