...
<Tabs>
  ...
  <TabItem label="Section">
    <p>To navigate users to the primary actions in the page.</p>
    <ExampleViewer type="section" />
  </TabItem>
  <TabItem label="Support">
    <p>To provide additional or supporting information about the actions in the page.</p>
    <Tabs>
      <TabItem label="Support">
  ...
  <TabItem label="Flat">
    <p>To group content and action that are part of the page.</p>
