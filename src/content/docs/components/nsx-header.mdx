...
<Tabs>
  ...
  <TabItem label="with dynamic links">
    <ExampleViewer type="standard-dynamic-links" />
  </TabItem>
</Tabs>
...
- Include `<nsx-header>` before the opening `<main>` element.
- Always situate the header at the top of a page.
:::

:::dont
- Use for partnership or microsites.
