...
<Tabs>
  ...
  <TabItem label="with Excess">
    <ExampleViewer type="with-excess" />
  </TabItem>
  <TabItem label="without Excess">
    <ExampleViewer type="without-excess" />
  </TabItem>
  <TabItem label="Pricing">
    <p>The `pricing` options available for the `<product-card>` components with the `<nsx-product-card-overview>`. </p>
    <Tabs>
        <TabItem label="Was / Now">
        <ExampleViewer type="was-now-pricing" />
      </TabItem>
      <TabItem label="Monthly primary and secondary">
        <ExampleViewer type="monthly-primary-secondary" />
      </TabItem>
    </Tabs>
  </TabItem>
</Tabs>
