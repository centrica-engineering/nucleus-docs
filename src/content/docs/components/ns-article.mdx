...
| <span class="marker">B</span> | Media | Videos should be hosted on YouTube and have an aspect ratio of `16 / 9`. There is a choice of 2 image sizes: [720 x 405px](/guidelines/assets#720x405px) and [720 x 540px](/guidelines/assets#720x540px). Images should be WebP filetype, the file size should be no more than 50kb. |
