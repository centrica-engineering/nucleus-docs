...
<ExampleViewer src="ns-inputter/standard.html" />
...
<ExampleViewer src="ns-inputter/text.html" />

#### Email

`<input type="email">`

<ExampleViewer src="ns-inputter/email.html" />

#### Tel

`<input type="tel">`

<ExampleViewer src="ns-inputter/tel.html" />

#### Search

`<input type="search">`

<ExampleViewer src="ns-inputter/search.html" />

#### Number

`<input type="number">`

<ExampleViewer src="ns-inputter/number.html" />

#### Textarea

`<input type="textarea">`

<ExampleViewer src="ns-inputter/textarea.html" />

#### Radio

`<input type="radio">`

<ExampleViewer src="ns-inputter/radio.html" />

##### `class="inline"`

<ExampleViewer src="ns-inputter/radio-inline.html" />

#### Checkbox

`<input type="checkbox">`

<ExampleViewer src="ns-inputter/checkbox.html" />

##### `class="inline"`

<ExampleViewer src="ns-inputter/checkbox-inline.html" />

#### Select

`<input type="select">`

<ExampleViewer src="ns-inputter/select.html" />

#### Mask

`mask=""`

<ExampleViewer src="ns-inputter/mask.html" />

#### Separator

`mask=""` and `separator=""`

<ExampleViewer src="ns-inputter/separator.html" />
