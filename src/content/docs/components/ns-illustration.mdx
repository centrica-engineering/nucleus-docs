...
To view all of the available illustrations for `<ns-illustration>` and their associated names, please see the Icons section on the [Assets Guidelines](../guidelines/assets#illustrations) page.
