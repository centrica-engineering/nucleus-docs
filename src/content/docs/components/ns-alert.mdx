...
:::caution
An issue currently exists with [NVDA screen reader (2024.4)](https://www.nvaccess.org/download/) whereby headings and lists contained within an element with `role="alert"` are not announced.

This is a known issue that has been raised on the NVDA GitHub repository. https://github.com/nvaccess/nvda/issues/14990
:::
