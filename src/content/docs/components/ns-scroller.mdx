...
### Standard (Replace with ns-scroller image)
...
| <span class="marker">D</span> | Pagination | Provides a visual indication to the user as to where they are in the list. (OMIT THIS FOR FIRST RELEASE!) |
...
(Placement, to be added dynamically:)Within a `ns-panel`, or as a child of `main`.

### Specification

<Specification name={componentName} />
(Spec, to be added dynamically:) Content types... `ns-action-link`, `ns-card`, `ns-video`...
