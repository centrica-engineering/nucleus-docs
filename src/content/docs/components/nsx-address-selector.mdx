...
:::updated
**02 February 2026**
- The `property-type` attribute defines the type of property for manual address entry forms.
...
<Tabs>
  ...
  <TabItem label="Allow manual address">
    <ExampleViewer type="standard-allow-manual-address" />
  </TabItem>
  <TabItem label="Manual address form">
    <Tabs>
      <TabItem label="Manual address form">
        <ExampleViewer type="standard-manual-address-form" />
      </TabItem>
      <TabItem label="with property-type">
        <ExampleViewer type="property-manual-address-form" />
      </TabItem>      
    </Tabs>
  </TabItem>
  <TabItem label="Single address">
    <ExampleViewer type="standard-addresses-single" />
  </TabItem>
  <TabItem label="Multiple addresses">
    <ExampleViewer type="standard-addresses-multiple" />
  </TabItem>
  <TabItem label="Many addresses">
    <ExampleViewer type="standard-addresses-many" />
  </TabItem>
</Tabs>
