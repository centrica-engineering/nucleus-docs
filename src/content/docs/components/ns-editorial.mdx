...
| <span class="marker">B</span> | Image | Use an image size of [480 x 360px](/guidelines/assets#480x360px). Images should be WebP filetype, the file size should be no more than 25kb. |
