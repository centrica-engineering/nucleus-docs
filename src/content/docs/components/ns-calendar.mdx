...
:::do
- Always use inside other components that require a calendar view  (e.g. [`<ns-datepicker>`](/components/ns-datepicker)).
:::

:::dont
- Use `<ns-calendar>` directly for data entry outside of another component.
:::
...
| :--- | :--- | :--- |
| <span class="marker">A</span> | `Date` | The date. |
| <span class="marker">B</span> | `Month`, `YYYY` | The month and year. |
