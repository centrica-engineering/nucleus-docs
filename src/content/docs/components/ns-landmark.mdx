...
| <span class="marker">B</span> | Content | A single, short paragraph works best. Can contain bold copy `<b>`, inline links `<a>` and a caveat at the end of the relevant paragraph if required `<a href="#caveat">1</a>`. |
| <span class="marker">C</span> | Action | See action guidance below |
| <span class="marker">D</span> | Decoration | Apply a colour decoration to the landmark. [The specification table](#specification) has a list of options. |
...
| <span class="marker">E</span> | Decoration | Apply a colour to the offset. [The specification table](#specification) has a list of options. |
