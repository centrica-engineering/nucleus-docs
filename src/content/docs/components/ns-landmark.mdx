...
import ExampleStandard from '../_examples/components/landmark/standard.html';
import ExampleSummit from '../_examples/components/landmark/summit.html';
import ExampleHillside from '../_examples/components/landmark/hillside.html';
import ExampleValley from '../_examples/components/landmark/valley.html';
import ExampleLakeside from '../_examples/components/landmark/lakeside.html';
...
![](../../../assets/components/landmark/content-guidance-summit.webp)
...
| ![do-father-child](../../../assets/components/landmark/best-practice-do1-summit.webp) | ![dont-covered-family](../../../assets/components/landmark/best-practice-dont1-summit.webp) |
| Set focus of the photo correctly. | Obstruct people's faces with the card. |
| ![do-couple-on-sofa](../../../assets/components/landmark/best-practice-do2-summit.webp) | ![dont-obstructed-face](../../../assets/components/landmark/best-practice-dont2-summit.webp) |
| Convey activity related to topic. | Use images with a white background. |
| ![do-boiler-service](../../../assets/components/landmark/best-practice-do3-summit.webp) | ![dont-boiler-on-white-background](../../../assets/components/landmark/best-practice-dont3-summit.webp) |

### Hillside

![](../../../assets/components/landmark/content-guidance-hillside.webp)
...
| ![do-use-same-colour-for-themed-pages](../../../assets/components/landmark/best-practice-do1-hillside.webp) | Add too much content in the landmark. |
| Keep the content concise. |  |
| ![do-keep-content-concise](../../../assets/components/landmark/best-practice-do2-hillside.webp) |  |

### Valley

![](../../../assets/components/landmark/content-guidance-valley.webp)
...
| ![use-a-checked-list](../../../assets/components/landmark/best-practice-do1-valley.webp) | ![dont-add-a-cta](../../../assets/components/landmark/best-practice-dont1-valley.webp) |
...
| ![complementary-image](../../../assets/components/landmark/best-practice-do2-valley.webp) | ![use-short-content](../../../assets/components/landmark/best-practice-dont2-valley.webp) |
| Use colour, pill and ratio options for alternative aesthetics | Forget to use an image |
| ![use-colour-and-ratio-options](../../../assets/components/landmark/best-practice-do3-valley.webp) | ![use-an-image](../../../assets/components/landmark/best-practice-dont3-valley.webp) |

### Lakeside

![](../../../assets/components/landmark/content-guidance-lakeside.webp)
...
| ![do-use-more-than-one-paragraph](../../../assets/components/landmark/best-practice-do1-lakeside.webp) | ![dont-use-more-than-three-paragraphs](../../../assets/components/landmark/best-practice-dont1-lakeside.webp) |
| Display 400 and 500 error pages. | Use to build a page. |
| ![display-400-and-500-error-pages](../../../assets/components/landmark/best-practice-do2-lakeside.webp) | ![dont-even-this-about-building-a-page-with-it](../../../assets/components/landmark/best-practice-dont2-lakeside.webp) |
| Get to the point, in this scenario the Sub heading and CTA have been omitted. |  |
| ![do-get-to-the-point](../../../assets/components/landmark/best-practice-do3-lakeside.webp) |  |
