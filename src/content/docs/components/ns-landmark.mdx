...
:::dont
- Use the red decoration for something that is not a promotional promotional or an error-themed page.
:::
...
:::do
- Use checked list to highlight your key product benefits.
...
:::dont
- Add a CTA if the purpose of the page is for users to consume the content. 
- Use long, verbose content. Keep the user interested with a snappy overview and draw them down the page.
