...
import ExampleStandard from '../_examples/components/accordion/standard.html';
...
![Labelled diagram of the Accordion component](../../../assets/components/accordion/content-guidance.webp)
