...
Figma component configuration instructions are only available to members of the British Gas workspace who have access to the Nucleus Figma UI Kit for British Gas.
