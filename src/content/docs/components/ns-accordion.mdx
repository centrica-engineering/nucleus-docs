...
:::dont
- Do not  use a background with an accordion – the expanded state is white.
- Don't exceed a maximum of 8 expanders.
- Do not use for critical information (such as caveats).
- Do not hide critical information within an accordion.
- It should not be used as a solution to excessive copy on a page.
- Refrain from using as the only component on a page.
:::
