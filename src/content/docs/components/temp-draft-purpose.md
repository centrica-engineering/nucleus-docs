...
> Use to expand and collapse multiple sections of content.
...
> Use to contain content in a consistent and structured way.
...
> Use to provide additional information and legal details to the content.
...
> Use to bring flexibility and control to responsive layouts.
...
> Use to display typography and media.
...
> Use to allow users to take action once they are ready.
...
> Use component to create a downloadable link for an asset.
...
> Use for self-contained or supporting content that is more informative than promotional.
...
> Use to group related `ns-inputter` components.

Use the `ns-fieldset` component instead of the usual HTML fieldset. The `ns-fieldset` extends the layout for the `ns-form`.

## ns-footer

> Use to show required links and information that needs repeating on every page.
...
> Use to collect customer input and provide a personal experience based on their needs.
...
> Use for the primary navigation of the website.
...
> Use to communicate information or error, warning and success messages.
...
> Use to display icons, the visual symbols used to represent functions, products and services.
...
> Use to display illustrations, the visual symbols used to bring the warmth of the British Gas brand and personality to the website.

Illustrations simplify products and services to users in a friendly manner. Illustrations always accompany the content.

## ns-image

> Use to display images. An image allows British Gas to share visual content.
...
> This is a multi-purpose wrapper component that helps display form input types.
...
> Use to introduce the page, informing users of their current location and its primary purpose.
...
> Use to draw attention to areas of the page that are dynamically updating.

The `ns-live` component comprises a loading icon, a helpful message and a subtle animation.

## ns-lockup

> Use as a promotional component that signposts to a product or service, highlighting key messages.
...
> Use as an empty container for each section on a page.
...
> Use as the standard component that supports users when entering a password.
...
> Use to attract customer attention to a piece of information.
...
> Use to standardise the way prices are displayed.
...
> Use to enable users to browse, compare and choose a product.

## ns-progress

> Use to indicate how far a user is through a journey and how many steps they have left to complete.

## ns-selector

> Use to group an image or illustration with a label into a card which users can select.
...
> Use as a placeholder to show that content is loading.
...
> Use to notify users of current, ongoing or upcoming events that may be relevant to them.
...
> Use to draw attention to important information that the user will need to know.
...
> Use as a singular tab that dictates what the area is about.
...
> Use to display information in a grid-like format of rows and columns. It organises information in a way that’s easy to scan so users can look for patterns and insights.
...
> Use to display verbatim quotes from people about us.
...
> Use to represent a sequence of events happening within a process.
...
> Use to display videos. It helps us share more visual and engaging content.
...
> This is a multi-functional experience pattern. Use this Nucleus experience (nsx-) for address-related tasks.
...
> This experience pattern is a wrapper of the `ns-footer` component. Use this Nucleus experience (nsx-) to display the website's legally required links and copyright information.
...
> This experience pattern is a wrapper of the `ns-header` component. Use this Nucleus experience (nsx-) as the primary navigation for the British Gas website.
...
> Use this experience pattern to capture a customer's contact preferences for marketing purposes.
...
> Use this experience pattern to compare HomeCare products against each other. See the price differences when choosing to apply an excess or not without reloading the entire page.
