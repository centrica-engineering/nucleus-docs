...
In addition to [accessibility principles](/getting-started/principles#accessibility-principles) and starting points to accommodate [different types of barriers](#types-of-barriers), we've made sure our components integrate [WCAG 2.1](https://www.w3.org/TR/WCAG21) Level AA practices.
