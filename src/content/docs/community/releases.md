...
* You can now use the `ns-product-card` to enable users to browse, compare and choose a product. You can find out how to use it [on our documentation](components/ns-product-card)
...
* Details of how to use masks and separators with [ns-inputter](components/ns-inputter)
* Supporting the new additions to our component library.
  * Take a look at our documentation for [ns-skyline](components/ns-skyline)
  * Check out the best practice for [lakeside](components/ns-landmark) Landmark
* Include a summary of our Squad achievements on [December 4th](/community/events)
...
* Supporting documentation for [ns-selector](components/ns-selector)
* Also, the initial documentation for [ns-table](components/ns-table)
* Introducing **Image guidance** and supporting image templates to our components which use an image.
  * [ns-editorial](components/ns-editorial#image-guidance)
  * [ns-landmark](components/ns-landmark#image-guidance)
  * [ns-lockup](components/ns-lockup#image-guidance)
  * [ns-card](components/ns-card#image-guidance)
...
* Component [ns-editorial](components/ns-editorial)
* Textarea - [ns-inputter](components/ns-inputter#textarea)
...
* [Modular scale](foundations/modular-scale)
* [Typography sizes](foundations/typography)
* [Optimise your images](foundations/photography)
* Our documentation - [https://britishgas.design](https://britishgas.design)
* [Accordion](components/ns-accordion)
