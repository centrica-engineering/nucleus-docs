...
When we are all confident with our changes, we can release, following semver.
...
If you would like to contribute to the design system, either with a change, or if you're looking for something new, then please read Contribute to Nucleus.