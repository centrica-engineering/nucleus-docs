...
We fall back to sans-serif to allow the operating system to provide the substitute.
...
This helps us to highlight different details and make sure legibility and readability are prominent in all our communications.

## Semantics vs. styles

The definitions we cover here refer to typographic styles. It's important to understand the separation of styles and semantics:
