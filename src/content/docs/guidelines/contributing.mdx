...
3. Add a new [Proposal (RFC) request for comments](https://github.com/ConnectedHomes/nucleus/issues/new?assignees=&labels=RFC,+draft&template=b--proposal.md&title=%5BRFC%5D+Title+of+the+Proposal), as well as react or comment on existing feedback.
