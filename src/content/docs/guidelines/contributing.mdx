...
It is recommended to check the [Proposal board](https://github.com/orgs/ConnectedHomes/projects/50) before raising a Proposal to ensure that no one else has already raised a similar idea.
...
:::tip
1. [Identify the need](https://nucleus.design/guidelines/contributing#1-identify-the-need)
2. [Propose your idea](https://nucleus.design/guidelines/contributing#2-propose-your-idea)
3. [Shape and refine](https://nucleus.design/guidelines/contributing#3-shape-and-refine)
4. [Stakeholder approval](https://nucleus.design/guidelines/contributing#4-stakeholder-approval)
5. [Optimise for the system](https://nucleus.design/guidelines/contributing#5-optimise-for-the-system)
6. [Submit for review](https://nucleus.design/guidelines/contributing#6-submit-for-review)
:::
...
- Check that there isn’t already a Proposal for the piece of work that is in mind. All Proposals can be found on the [kanban board](https://github.com/orgs/ConnectedHomes/projects/50) along with their status.
...
1. View the [Proposals status](https://github.com/orgs/ConnectedHomes/projects/50).
...
1. Track and add suggestions for new assets in GitHub by checking the [status of requests](https://github.com/orgs/ConnectedHomes/projects/50).
