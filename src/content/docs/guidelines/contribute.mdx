...
![Proposal flowchart](../../../assets/guidelines/contribute/contribute-decision-tree.webp)
...
To understand how the Nucleus team works, visit [Our Process](../guidelines/process.mdx).
