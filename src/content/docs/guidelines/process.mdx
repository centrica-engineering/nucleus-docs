...
If a change is quite *simple* or *obvious* it might need a quick community validation. Other times it might need several workshops, a whole round of communication with the community and several iterations of discovery.
...
If you would like to contribute to the design system, either with a change, or if you're looking for something new, then please read [Contribute to Nucleus](../guidelines/contributing/).