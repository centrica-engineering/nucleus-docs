...
Our [vanilla first](/guidelines/vanilla-first) approach will help understand where the starting point of the solution is. Which, in turn will help define the outcome of the work.
