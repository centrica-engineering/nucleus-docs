...
Individuals who contribute to Nucleus have the ability to [create a Proposal](https://github.com/ConnectedHomes/nucleus/issues/new?assignees=&labels=RFC%2Cdraft&projects=ConnectedHomes%2Fnucleus%2F6&template=b--proposal.yaml&title=%5BRFC%5D+Title+of+the+Proposal) in the GitHub repository.
