...
This is an inclusive, community-driven design system. To help deliver this, we hold ourselves accountable and measure ourselves against these principles:
...
The four accessibility principles (POUR) are derived straight from [WCAG 2.1](https://www.w3.org/TR/WCAG21/). For each principle, WCAG provides in-depth documentation and guidance. Below, we've restated the principles as well as provided a bit of background into Level AA conformance.

Our [Accessibility guidelines](/guidelines/accessibility) describe in further detail how these principles have been applied.
...
We tailor our experiences to the individuality of each customer and the channel they might appear in. We use data and insights to understand our customers' needs and use personalisation and smart technologies to predict and act, not react.

- If we know a customer's name, we prefill their details.
- We don't promote products customers already have.
