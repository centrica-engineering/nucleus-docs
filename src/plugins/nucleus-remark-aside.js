...
export function nucleusRemarkAside() {
  ...
  const isAsideVariant = (s) => variants.has(s);
    ...
    updated: [
      s('path', {
        d: 'm1.439 8.855 3.528-3.517c.34-.344.802-.541 1.285-.548h6.649l.947-.947C16.919.772 20.055.771 21.468.975a1.82 1.82 0 0 1 1.557 1.557c.204 1.413.203 4.549-2.868 7.62l-.946.946v6.649a1.843 1.843 0 0 1-.549 1.286l-3.516 3.528a1.842 1.842 0 0 1-3.11-.944l-.858-4.275-4.519-4.52-4.275-.857a1.843 1.843 0 0 1-.945-3.11Zm7.879 9.49a.972.972 0 0 0-1.859-.561c-.483 1.435-1.688 2.204-2.935 2.619a8.186 8.186 0 0 1-1.229.302c.061-.365.156-.79.302-1.229.415-1.247 1.184-2.452 2.619-2.935a.967.967 0 0 0 .612-1.23.97.97 0 0 0-1.231-.612c-.12.041-.236.084-.349.13-2.022.828-3.013 2.588-3.494 4.033a10.371 10.371 0 0 0-.503 2.659l-.009.265c0 .536.435.972.972.972l.265-.009a10.371 10.371 0 0 0 2.659-.503c1.445-.481 3.205-1.472 4.033-3.494l.147-.407Zm4.586 2.709-.776-3.873 4.14-4.14v4.639l-3.364 3.374Zm1.318-15.837c2.459-2.459 4.856-2.463 5.89-2.329.134 1.034.13 3.431-2.329 5.89l-6.71 6.71-3.561-3.561 6.71-6.71Zm-8.403 5.655-3.873-.776L6.32 6.733h4.638l-4.139 4.139Z',
      })
    ]
  };
